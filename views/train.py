...
from models.model import getModelTrainer_v1, getModelTrainer_v2, getModelTrainer
...
def train_v2(model_name: str):  # if python_code and dataset:
    m1 = getModelTrainer_v2(model_name)
